...
use etude_buffer::reader::Buffer;
...
/// Forward offset tracking through the buffer-layer `Tracked` adapter.
impl<S: Stream + ?Sized> Stream for etude_buffer::reader::Tracked<'_, S> {
    #[inline]
    fn current_offset(&self) -> u64 {
